...
probe_list = ['4','8','10','24','29']
#Declare size of time series
Total_Time_Step = 49500
Chunk_Size = 500

N = int(Total_Time_Step/Chunk_Size)
rotation_center_x = -0.067
rotation_center_y = 0.0209
rotation_degree = 7 #Angle of rotation (clockwise) with respect to 8 degree airfoil.
...
for probe in probe_list:
	...
	#Create new array for pressure matrix at selected point and write it into a file
	np.savetxt('probe_pressure/probe_{}_pressure.txt'.format(probe), pressure_history, fmt='%.18e', delimiter=' ', newline='\n', header='time,pressure')
